<!--Vamooooooooooooooooooooooooooooooooo-->
<?php
include "conexao.php";
...
<body>
    <div class="container">
        ...
        <a href="adicionar.php" class="btn btn-success">Adicionar Filme </a>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
                <?php while($item = mysqli_fetch_object($rs)) { ?>
                    <tr>
                        ...
                        <td><?php echo $item->filme; ?></td>
                        <td><?php echo $item->genero; ?></td>
                        <td><?php echo $item->duracao; ?></td>
                        <td><?php echo $item->estudante; ?></td>
                        <td>
